...
class ListViewController: UIViewController {
    ...
    enum CellIdenifire {
        static let COLLECTIONVIEW_CELL_IDENTIFIRE = "collectionButtonCell"
        static let TABLEVIEW_CELL_IDENTIFIRE = "carListTableCell"
    }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.presenter = CarListPresenter()
        self.addCollectionsStabs()
        self.makeConstraints()
        self.configureNavigationBar()
        self.createTableViewObserver()
    }
    ...
    private func addCollectionsStabs () {
        ...
        self.filterButtonsCollectionView.delegate = self
        self.filterButtonsCollectionView.dataSource = self
    }
    ...
    @objc private func presentAddingController () {
    ...
    private func makeConstraints  () {
        ...
        [filterButtonsCollectionView, carTableView].forEach
        { view.addSubview($0) }
...
extension ListViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        presenter.buttonPressed(type: Body.allCases[indexPath.row])
    }
}
